...
import com.example.spring_ai_demo.adapter.in.web.dto.AssistantUIThreadMessage;
...
public class ChatController {
    ...
    public AssistantUIContent chat(@RequestBody AssistantUIThreadMessage message) {
